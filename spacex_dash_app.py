...
# Getting Launch Sites from dataframe
launch_sites = spacex_df['Launch Site'].unique()
launch_sites = [{'label': site, 'value': site} for site in launch_sites]
launch_sites = [{'label': 'All sites', "value": "ALL"}] + launch_sites
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', placeholder="Select a Launch Site here",
                                             searchable=True,
                                             options=launch_sites, value="ALL"),
                                html.Br(),
                                ...
                                dcc.RangeSlider(id='payload-slider', min=0, max=10000, step=1000,
                                                marks={0: '0', 2500: '1500', 5000: '5000', 7500: '7500', 10000: '10000'},
